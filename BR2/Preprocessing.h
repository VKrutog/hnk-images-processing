...
public:
	...
	static int RemoveBigSmallBlobs5(Mat* bmp);
	static int RemoveBigSmallBlobs3_h(Mat* bmp);
	static int RemoveBigSmallBlobs3_v(Mat* bmp);
	static int RemoveBigSmallBlobs6(Mat* bmp);
	static int RemoveBigSmallBlobs7(Mat* bmp);
	static Point Coord6(Mat* big);
